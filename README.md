...
![image-20240225175008463](D:\project\java_project\sca-k8s-demo\images\image-20240225175008463.png)
...
![image-20240225175920425](D:\project\java_project\sca-k8s-demo\images\image-20240225175920425.png)

创建成功如下所示：

![image-20240225180004647](D:\project\java_project\sca-k8s-demo\images\image-20240225180004647.png)

执行 `kubectl create -f sca-k8s-demo-nacos.yaml` 创建 nacos 需要的 mysql 服务：

![image-20240225180104329](D:\project\java_project\sca-k8s-demo\images\image-20240225180104329.png)

创建成功如下所示：

![image-20240225180603568](D:\project\java_project\sca-k8s-demo\images\image-20240225180603568.png)
...
![image-20240225182956824](D:\project\java_project\sca-k8s-demo\images\image-20240225182956824.png)

#### 打包 Docker Images

修改应用配置文件中的 nacos server 地址为端口转发时使用的虚拟机地址，确保服务成功注册。consumer 和 provider 同时修改。

![image-20240225183636922](D:\project\java_project\sca-k8s-demo\images\image-20240225183636922.png)
...
![image-20240225210717202](D:\project\java_project\sca-k8s-demo\images\image-20240225210717202.png)

执行 `kubectl logs sca-k8s-demo-provider-service-xxxx` 查看 pod 日志，发现激活的配置文件为 `k8s`：

![image-20240225210541866](D:\project\java_project\sca-k8s-demo\images\image-20240225210541866.png)

查看 nacos 控制台，发现 provider 已经注册：

![image-20240225210515801](D:\project\java_project\sca-k8s-demo\images\image-20240225210515801.png)

consumer 部署方式相同，执行 `kubectl create -f sca-k8s-demo-consumer.yaml` 即可部署。

最终部署所有的 k8s pod 如下图：

![image-20240225210835325](D:\project\java_project\sca-k8s-demo\images\image-20240225210835325.png)
